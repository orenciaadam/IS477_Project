# IS477_Project
IS 477 Group Repository: Adam Orencia, Daniel Newman
...
Our genre analysis was also interesting. We found that documentaries surprisingly led the ranks in our obtained sample. It averaged above 7.3, while more popular genres like action and comedy were under 6.5. This could support the idea that documentaries, even though they bring in a smaller audience, appeal better to niche audiences, which makes them enjoyable for specific groups. We also hypothesize that this could be due to the number of released movies that perform poorly, bringing the average ratings down.

**Figure: Rating by Primary Genre**  
![Rating by Genre](../figures/rating_by_genre.png)
